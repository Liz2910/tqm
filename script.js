...
function spawnParticles(type = "hearts", amount = 50, duration = [240000, 240000]) {
  clearParticles();
...
const slides = [
  ...
  // 4: Texto apreciar + fondo libre
  {
    title: "¿Sabías que... ?🌙",
    effect: null,
    text: "Enfin, ¿sabías que existen cosas muy bonitas que se deben de apreciar? Como el cielo, las flores, la luna, los atardeceres y... tú! te quiero mucho guapo, muaaa!",
    buttons: [{ label:"Siguiente", next:true }]
  },
  ...
  // 7: “Habrá un pedazo de ti en mí…”
  {
    title: "Always on me 💭",
    effect: null,
    text: "Me gustaría que supieras que habrá un pedazo de ti en mi siempre y estoy agradecida por eso, sea cual sea la persona en la que te conviertas, y donde quiera que estés en el mundo, lejos o cerca de mí, te envío amor y cariño y te lo daré siempre que te tenga cerca de mi, suelo demostrarlo más con acciones que con palabras btw.",
    buttons: [{ label:"Siguiente", next:true }]
  },
  // 8: “Te quiero a ti…”
  {
    ...
    effect: null,
    text: "Te quiero a ti, a tus miedos, inseguridades, tus fuerzas y tus debilidades, quiero tus sonrisas y tus lágrimas, tus carcajadas y tus silencios, te quiero hasta que me lo permitas y por toda la vida aunque tomemos caminos separados en un futuro o sigamos siendo amigos o lo que sea, no me importa, pero siempre habrá algo de ti en mi y eso es lo que importa.",
    buttons: [{ label:"Siguiente", next:true }]
  },
